...
class FamiliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family" do
    assert_difference('Family.count') do
      post families_url, params: { family: { admin: @family.admin, family_id: @family.family_id, user_id: @family.user_id } }
    end
  ...
  test "should update family" do
    patch family_url(@family), params: { family: { admin: @family.admin, family_id: @family.family_id, user_id: @family.user_id } }
